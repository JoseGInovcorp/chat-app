...
<div class="py-12 animate-fadeIn">
    <div class="max-w-3xl mx-auto space-y-6">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 text-gray-900 dark:text-gray-100">
            <p class="text-lg font-medium">Estás autenticado como <strong>{{ Auth::user()->role }}</strong>.</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Escolhe uma opção para começar:</p>
