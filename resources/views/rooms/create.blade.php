<x-app-layout>
    ...
    <div class="py-6 animate-fadeIn">
        <form method="POST" action="{{ route('rooms.store') }}" 
              class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 space-y-6 max-w-xl mx-auto">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}"
                       ...
                       required aria-required="true" aria-label="Nome da sala">
                @error('name')
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="avatar" id="avatar" value="{{ old('avatar') }}"
                       class="block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                       aria-label="URL do avatar da sala"
                ...
                <img id="avatar-preview" src="{{ old('avatar') ?: 'https://ui-avatars.com/api/?name=Sala' }}"
                     ...
                     class="w-16 h-16 rounded border mt-2 shadow-sm"
                     alt="Pré-visualização do avatar da sala"
                     loading="lazy">
            </div>
